...
const PrivacyPolicy = () => {
    return (
        <>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <h1 className='text-white display-4 fw-bold text-center'>Privacy Policy</h1>
                            <h4 className='para text-light fs-6 text-center'>Writing Space is a website belonging to Business Bliss Consultants FZE. We can be contacted using the details given at the bottom of this page. This privacy policy tells you what to expect when we collect and process your personal data, the rights that are available to you and how you can exercise them.</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <article class="col-sm-9 mx-auto my-4">
                        ...
                        <p>Some of this data is processed via a company called Zendesk, who provide a live chat and ticket management system which helps us to process some customer communications more efficiently. You can read Zendesk's privacy policy <a href="https://www.zendesk.com/company/customers-partners/privacy-policy/" rel="nofollow noopener" target="_blank">here.</a></p>
                        ...
                        <p>To exercise your rights if you are outside the EU:</p>
                        <p>Please send your request to our data protection officer at dpo@business-bliss.com. After we have received proof of your identity, we will respond to your request within one calendar month.</p>
                        ...
                        <h3>Transfers to countries outside the UK</h3>
                        <p>Some of the third parties we use to process your data are based in countries which do not have the same standard of data protection laws that UK citizens enjoy. In these cases, we have made sure there are safeguards in place to protect your rights and interests.</p>
                        <h3>Children</h3>
                        ...
                        <p>Customers using the website who are minor/under the age of 18 shall not register as a User of the website and shall not transact on or use the website.</p>
                        <h3>Links to other websites</h3>
                        <p>Our websites may contain links to external third-party websites. We are not responsible for the privacy and security of these websites unless they belong to Business Bliss Consultants FZE. This privacy policy applies only to Writing Space.</p>
                        <h3>Payment Data</h3>
