...
const CustomOrder = () => {
    ...
    const onCreate = (data) => {
        ...
        formData.append('erp_order_topic', data.erp_order_topic);
        formData.append('erp_status', 0);
        formData.append('erp_user_id', data.erp_user_id);
        formData.append('erp_order_message', noteValue);
        formData.append('erp_academic_name', data.erp_academic_name);
        formData.append('erp_paper_type', data.erp_paper_type);
        formData.append('papertype_desc', data.papertype_desc);
        formData.append('papertype_file', data.papertype_file);
        formData.append('erp_subject_name', data.erp_subject_name);
        formData.append('erp_paper_format', data.erp_paper_format);
        formData.append('erp_language_name', data.erp_language_name);
        formData.append('erp_resource_materials', data.erp_resource_materials);
        formData.append('erp_number_Pages', data.erp_number_Pages);
        formData.append('erp_spacing', data.erp_spacing);
        ...
        formData.append('erp_statistical_analysis', data.erp_statistical_analysis);

        formData.append('erp_academic_description', data.erp_academic_description);
        formData.append('erp_sub', data.erp_sub);
