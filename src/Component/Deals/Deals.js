                            ...
                            <div className="col-lg-9 col-md-12">
                                {isLoading ?
                                    ...
                                    <>
                                        ...
                                        {searchedCoupons ? (searchedCoupons.slice(dataFrom, dataTo).map((item) => {
                                            return <List style={style} singleurl={item.coupon.slug} image={`${item.image_path}/${item.media.image}`} title={item.coupon.title} discount={item.coupon.discount} rprice={item.coupon.regular_price} cprice={item.coupon.compare_price} />
                                        })) : "No Coupon Found!"}


                                        <div div className='pagination mt-4 justify-content-center'>
